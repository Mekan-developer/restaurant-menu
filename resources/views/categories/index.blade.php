        ...
        <table class="table">
          ...
          @foreach($categories as $category)
            <tr class="tb-tnx-item">
              ...
              <td>@if($category->parent_id) <em class="icon ni ni-check"></em> @else ― @endif</td>
              ...
              <td class="tb-col-action">
                ...
                <span>
                  <a href="#" onclick="if (confirm('{{ trans("main.want_to_remove") }}')) { document.getElementById('destroy-{{ $category->id }}').submit(); }"
