...
class CategoryController extends Controller
{
     ...
     public function order()
    {
        ...
        $subCategories = Category::whereNotNull('parent_id')->orderBy('order')->get();

        if (count($categories) > 1 || $subCategories > 1) {
            return view('categories.order', compact('categories','subCategories'));
        }
